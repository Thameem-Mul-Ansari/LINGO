...
class StockAnalysisTasks:
    ...
    # Analyze the latest Quarterly Financial Results and Annual
    # Reports from the BSE/NSE for the stock in question.
    # Focus on key sections like Director's Report, Management's
    # Discussion and Analysis, financial statements, insider trading activity, and any disclosed risks.
    # Extract relevant data and insights that could influence the stock's future performance.
    # Your final answer must be an expanded report that now also highlights significant findings from these filings,
    # including any red flags or positive indicators for your customer.
